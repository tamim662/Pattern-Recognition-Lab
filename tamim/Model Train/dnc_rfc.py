...
# %%
x_train_pos=np.load('Dataset/numpy/A.thaliana5289_pos/DNC.npy')
x_train_neg=np.load("Dataset/numpy/A.thaliana5289_neg/DNC.npy")
x_test_pos=np.load("Dataset/numpy/A.thaliana1000indep_pos/DNC.npy")
x_test_neg=np.load("Dataset/numpy/A.thaliana1000indep_neg/DNC.npy")
